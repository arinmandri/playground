import type { Y_PAttachment, Y_PAttachmentImage, Y_PAttachmentFile, Z_PAttachmentAdd, Z_PAttachmentAddFile, Z_PAttachmentAddImage, Z_PAttachmentNoo, Z_PAttachmentOld } from '@/api/schemas';
