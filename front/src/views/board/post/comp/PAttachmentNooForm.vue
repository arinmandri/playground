<template>
  ...
  <div v-if="attachment.type == NOO_TYPE.old">OOOOOOOOOOOLLLLLLLLLLDDDDDDDDDDDDDDDDDDD</div>
</template>
...
import { PAttachmentAddData, type PAttachmentNooData, PAttachmentNewData, PAttachmentOldData, NOO_TYPE } from "@/views/board/post/comp/types";
