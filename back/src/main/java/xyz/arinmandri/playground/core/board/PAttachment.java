...
public abstract class PAttachment extends BaseEntityWithoutId
{
	...
	@SequenceGenerator( name = "playground.pattachment_seq" , sequenceName = "playground.pattachment_seq" , schema = "playground" ,// 스키마 명시했는데 Hibernate가 `select nextval('pattachment_seq')`라고 찾음 ㅡㅡ
